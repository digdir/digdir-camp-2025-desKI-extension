...
export const nn = {
  ...
  [KEY.solutions_list]: [
    ...
    'eSignering',
    'Kontakt- og reservasjonsregisteret',
    'Digital postkasse til innbyggjarar',
    'eInnsyn',
    'ELMA',
    'Tilsettportalen',
    'Peppol eGovernment',
...
export const ns = {
  ...
  [KEY.solutions_list]: [
    ...
    'eFormidling',
    'eSignering',
    'Oktavuođa- ja várreregistara',
    'Digitála poastakássa álbmogaide',
    'eInnsyn',
    'ELMA',
    'Bargoveahkaoaivi',
    'Peppol eGovernment',
  ...
  // ==================== //
  [KEY.servicedesk]: 'Servicedesk',
  [KEY.brukerstotte]: 'Geavaheddjiduorjun',
